...
class ShotSprite(Sprite):
    ...
    def __init__(self, game, img, x, y):
        ...
        self.game = game
        self.dy = -20
        self.hit_sound = pygame.mixer.Sound('./sound/sound/hit_sound.mp3')
        self.shot_sound = pygame.mixer.Sound('./sound/sound/shot_sound.mp3')
...
class GalagaGame():
    ...
    def __init__(self, master):
        ...
        self.canvas.pack()
        self.shotImage = tkinter.PhotoImage(file="./image/image/fire.png")
        self.shipImage = tkinter.PhotoImage(file="./image/image/starship.png")
        self.alienImage = tkinter.PhotoImage(file="./image/image/alien.png")
        self.shotImage = tkinter.PhotoImage(file="./image/image/fire.png")
        self.running = True
        self.initSprites()
        ...
        self.shot_sound = pygame.mixer.Sound('./sound/sound/shot_sound.mp3')
        self.start_sound = pygame.mixer.Sound('./sound/sound/start_sound.mp3')
...
if __name__ == "__main__":
    root = tkinter.Tk()  # main문 작성시 지워주세요.
