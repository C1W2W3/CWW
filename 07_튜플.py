...
'''
numbers1 = (12,1 ,54, 6, 84 ,78)              # ()로 튜플 만들기
numbers2 =  15354, 878, 87, 8, 5            # ()없이 튜플 만들기
...
num1 = (37)        # ()로 만든 경우
num2 = (37, )      # (,)로 만든 경우
num3 = 37          # 숫자 1개만 넣어준 경우
num4 =  37,        # 숫자, 로 만들어준 경우
...
print(numbers.count(3))         # .count(): 입력한 숫자가 튜플에 몇 개 있는지 세어주는 함수(메서드)
